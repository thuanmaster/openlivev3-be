...
export class MoleculerDBService<T, R> extends moleculer.Service<T> {
	...
	public responseSuccess(data: object) {
		return { status: 'success', code: 200, data };
	}

	public responseSuccessNon(data: object) {
		return data;
	}

	public responseSuccessDataMessage(msg: String, data: object) {
		return { status: 'success', code: 200, data, message: msg };
	}

	public responseSuccessMessage(msg: String) {
		return { status: 'success', code: 200, message: msg };
	}

	public responseError(code: String, msg: String) {
		/**
		 * This is Error with known reasons
		 * Todo
		 * Notify Telegram Development Group
		 * Bug Level: Medium
		 * Type: Unkown
		 */
	...
	public responseErrorData(code: String, message: String, data: Object | null) {
		/**
		 * This is Error with known reasons
		 * Todo
		 * Notify Telegram Development Group
		 ...
		 * Type: Unkown
		 */
		return { status: 'error', code: code, message, data };
	}

	public responseUnkownError() {
		/**
		 * This is Error with UN-KNOWN reasons
		 * Todo
		 * Notify Telegram Development Group
		 * Bug Level: High
		 * Type: Unkown
		 */
		return { status: 'error', code: 'err_unknown', message: 'Unknown Error' };
	}
}
